    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center z-50 text-white font-sans p-6 bg-black/30 backdrop-blur-sm transition-all duration-1000">
      <div className="max-w-md w-full bg-slate-900/90 p-8 rounded-2xl border border-slate-700 shadow-2xl backdrop-blur-xl relative overflow-hidden animate-fade-in">
        ...
        <div className="relative z-10 text-center">
            <h1 className="text-6xl font-black mb-2 bg-gradient-to-br from-white via-cyan-200 to-blue-400 bg-clip-text text-transparent tracking-tight">
            SkyLand
            </h1>
            ...
            <div className="mt-8 text-center">
                <a 
                    href="https://www.linkedin.com/in/harishik-dev-singh-jamwal-b31b60288" 
                    target="_blank" 
                    rel="noreferrer" 
                ...
                >
                    ...
                    <span className="font-bold group-hover:underline decoration-cyan-500/50 underline-offset-2">@Harishik</span>
                </a>
            </div>
        </div>
      </div>
